function [centers,radii] = hough(im,diamRange,sensitivity,edgethresh,polarity,titleStr,param3)
...
%     param3: the image you want to show the circles found on. Must be gray
...
for i = 1:num
    ...
    subplot(subx,suby,i), imshow(param3(:,:,i))
